...
import com.kook1932.springboot.domain.user.Role;
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http
                ...
                .and()
                    ...
                    // authorizeRequests가 선언되어야만 antMatcher 옵션을 사용할 수 있다.
                    ...
                    // anyRequest는 설정한 값들 이외의 나머지 URL들을 나타낸다.
                    // 여기에서는 authenticated()을 추가하여 나머지 URL들은 모두 인증된 사용자들에게만 허용한다.
