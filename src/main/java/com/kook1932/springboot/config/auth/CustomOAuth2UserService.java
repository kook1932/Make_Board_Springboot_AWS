...
import com.kook1932.springboot.config.auth.dto.OAuthAttributes;
import com.kook1932.springboot.config.auth.dto.SessionUser;
import com.kook1932.springboot.domain.user.User;
import com.kook1932.springboot.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException{
        ...
        // SessionUser은 사용자 정보를 저장하기 위한 Dto 클래스이다.
